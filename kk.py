...
#    server.login('ali01114605945@gmail.com', opop)
    ...
    for pathF in x:
        ...
        try:
            ...
            x.remove(pathF + '\n')
            f2 = open('.test.txt', 'w')
	    fff = aass+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))
	    print ('{}[{}+{}] {}'.format(w,b,w,fff))
            for i in x:
                f2.write(i)
            f2.close()
...
def ali():
 import requests
 from random import randint , choice
 #print ('{}[{}-{}] {}'.format(w,r,w,all))

 while True:
  time.sleep (0.7)
  ff = aass+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))+str(randint(0,9))
  print ('{}[{}-{}] {}'.format(w,r,w,ff))
'''
